...
dat = read_tsv("../src/RevisionStuff/temp3Results_20_5_1.0_50_8675309.tsv")
#dat = read_tsv("../src/RevisionStuff/temp3Results_20_10_1.0_50_8675309.tsv")
...
#ggsave("~/Dropbox/NSF Career 2019/V1/Figures/LowIdiosyncrancy.pdf", g, height=2.16, width=2.16, units="in")
...
#ggsave("~/Dropbox/NSF Career 2019/V1/Figures/HighIdiosyncrancy.pdf", g, height=2.16, width=2.16, units="in")
...
ggsave("~/Dropbox/NSF Career 2019/V1/Figures/MedIdiosyncrancy.pdf", g, height=2.16, width=2.16, units="in")
